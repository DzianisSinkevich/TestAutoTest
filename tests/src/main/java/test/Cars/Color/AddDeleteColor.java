...
public class AddDeleteColor {
	static boolean flag = true;

	static String colorCars1;

	static List<String> colorCars = new ArrayList<String>();
	...
	public static void main(String[] args) throws InterruptedException {
		...
		colorCars.add("option0");
		colorCars.add("option1");
		colorCars.add("option2");
		colorCars.add("option3");
		colorCars.add("option4");
		...
		if (checkAddedBrands(driver)) {
			deleteEmployee(driver, colorCars1);
			checkAmmountBrand(driver);
		}
	}
	...
	public static void openCars(WebDriver driver) throws InterruptedException {
		...
		Thread.sleep(1500);
		driver.findElement(By.cssSelector("[data-target='.tab-colors']")).click();
		Thread.sleep(2000);
	}
	...
	public static void checkAmmountBrand(WebDriver driver) throws InterruptedException {
		...
		if (elements.size() != 0) {
			...
			while (flag == true) {
				...
				if (brandName1.equals(colorCars1)) {
	...
	public static void deleteEmployee(WebDriver driver, String callsign) throws InterruptedException {
		...
		while (flag == true) {
			...
			if (brandName2.equals(colorCars1)) {
				Thread.sleep(1000);
