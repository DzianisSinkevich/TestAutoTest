...
public class AddDeleteType {
	...
	static String typeCars1;

	static List<String> typeCars = new ArrayList<String>();
	...
	// поиск добавленного типа т/с в таблице
	public static void checkAmmountBrand(WebDriver driver) throws InterruptedException {
		...
		if (elements.size() != 0) {
			...
			while (flag == true) {
				...
				if (typeName1.equals(typeCars1)) {
					System.out.println("Sought-for type is found.");
					break;
				}
				...
				if (typeName1.equals(typeName2)) {
					System.out.println("Sought-for type is not found.");
					break;
				}
				typeName1 = typeName2;
			}
